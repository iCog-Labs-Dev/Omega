...
agent reads. Needs a built image (OMEGA_KB_IMAGE) and Docker.

Run:
    cd Autotests && OMEGA_KB_IMAGE=<image> \
...
pytestmark = pytest.mark.skipif(
    not IMAGE or not _docker_ok() or not (REPO / "scripts" / "omega").exists(),
    reason="needs OMEGA_KB_IMAGE, Docker, and scripts/omega",
)
